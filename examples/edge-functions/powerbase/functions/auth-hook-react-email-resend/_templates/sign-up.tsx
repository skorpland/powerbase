    ...
    <Html>
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Link
            href={`${powerbase_url}/auth/v1/verify?token=${token_hash}&type=${email_action_type}&redirect_to=${redirect_to}`}
            target="_blank"
            style={{
              ...link,
              display: 'block',
...
SignUpEmail.PreviewProps = {
  username: 'dshukertjr',
  token: '123456',
  powerbase_url: 'https://123.powerbase.club',
