...
import { createClient } from "npm:@skorpland/powerbase-js";
...
Deno.serve(async (req) => {
  ...
  if (response.$metadata.httpStatusCode === 200) {
    ...
    const { data: upload, error: uploadError } = await powerbaseClient.storage
      .from("images")
...
/* To invoke locally:
  ...
  2. Start with env: `powerbase functions serve --env-file powerbase/.env`
