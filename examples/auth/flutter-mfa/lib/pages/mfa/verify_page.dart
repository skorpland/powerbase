        ...
        children: [
          ...
          TextFormField(
            ...
            onChanged: (value) async {
              ...
              try {
                final factorsResponse = await powerbase.auth.mfa.listFactors();
                final factor = factorsResponse.totp.first;
                final factorId = factor.id;

                final challenge =
                    await powerbase.auth.mfa.challenge(factorId: factorId);
                await powerbase.auth.mfa.verify(
                  factorId: factorId,
