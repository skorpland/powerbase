...
/// Extract PowerbaseClient instance in a handy variable
...
final _router = GoRouter(
  ...
  redirect: (context, state) async {
    ...
    final session = powerbase.auth.currentSession;
    ...
    final assuranceLevelData =
        powerbase.auth.mfa.getAuthenticatorAssuranceLevel();
    ...
    if (assuranceLevelData.currentLevel == AuthenticatorAssuranceLevels.aal1) {
      await powerbase.auth.refreshSession();
      final nextLevel =
          powerbase.auth.mfa.getAuthenticatorAssuranceLevel().nextLevel;
