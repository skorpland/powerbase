...
const FONT_URLS = {
  CIRCULAR:
    'https://xguihxuzqibwxjnimxev.powerbase.club/storage/v1/object/public/fonts/CircularStd-Book.otf',
  MONO: 'https://xguihxuzqibwxjnimxev.powerbase.club/storage/v1/object/public/fonts/SourceCodePro-Regular.ttf',
}
