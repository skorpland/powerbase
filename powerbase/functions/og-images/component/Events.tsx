...
const STORAGE_URL = 'https://obuldanrptloktxcffvn.powerbase.club/storage/v1/object/public'
...
const CustomerStories = (props: Props) => {
  ...
  const powerbaseLogoUrl = `${STORAGE_URL}/powerbase-brand-assets/logos/powerbase-logo-wordmark--dark.png`
  ...
  return (
    ...
    >
      ...
      <div tw="flex flex-row items-center justify-center top-0 mb-20">
        <img src={powerbaseLogoUrl} width="165px" height="31.73px" tw="mr-6" />
      </div>
