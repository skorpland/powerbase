 ...
 * https://github.com/skorpland/powerbase/blob/master/packages/common/telemetry-constants.ts
 *
...
export interface FeaturePreviewEnabledEvent {
  ...
  properties: {
    /**
     * Feature key of the preview that was enabled. e.g. powerbase-ui-api-side-panel
     */
    feature: string
  }
  groups: {
...
export interface FeaturePreviewDisabledEvent {
  ...
  properties: {
    /**
     * Feature key of the preview that was disabled. e.g. powerbase-ui-api-side-panel
     */
    feature: string
  }
  groups: {
...
/**
 * User copied the command for a Powerbase UI component.
 *
 * @group Events
 * @source powerbase-ui
 * @page /ui/docs/{framework}/{templateTitle}
 */
export interface PowerbaseUiCommandCopyButtonClickedEvent {
  action: 'powerbase_ui_command_copy_button_clicked'
  properties: {
    templateTitle: string
    command: string
...
export type TelemetryEvent =
  ...
  | PowerbaseUiCommandCopyButtonClickedEvent
