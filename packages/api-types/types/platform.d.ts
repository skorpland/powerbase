...
export interface paths {
  ...
  '/platform/integrations/github/connections': {
    ...
    put?: never
    /** Connects a GitHub project to a powerbase project */
  ...
  '/platform/integrations/github/connections/{connection_id}': {
    ...
    options?: never
    head?: never
    /** Updates a GitHub connection for a powerbase project */
  ...
  '/platform/integrations/vercel/connections': {
    ...
    get?: never
    put?: never
    /** Connects a Vercel project to a powerbase project */
  ...
  '/platform/integrations/vercel/connections/{connection_id}': {
    ...
    options?: never
    head?: never
    /** Updates a Vercel connection for a powerbase project */
  ...
  '/platform/integrations/vercel/connections/{connection_id}/sync-envs': {
    ...
    get?: never
    put?: never
    /** Syncs powerbase project envs with given connection id */
  ...
  '/platform/projects/{ref}/config/powervisor': {
    parameters: {
      query?: never
      header?: never
      path?: never
    ...
    /** Gets project's powervisor config */
    get: operations['PowervisorConfigController_getPowervisorConfig']
    put?: never
    post?: never
    delete?: never
    options?: never
    head?: never
    /** Updates project's powervisor config */
    patch: operations['PowervisorConfigController_updatePowervisorConfig']
    trace?: never
  }
...
export interface components {
  schemas: {
    ...
    CreateProjectBody: {
      ...
      custom_powerbase_internal_requests?: components['schemas']['CustomPowerbaseInternalRequests']
    ...
    CustomPowerbaseInternalRequests: {
    ...
    ListGitHubConnectionsConnection: {
      ...
      powerbase_changes_only: boolean
      updated_at: string
    ...
    UpdatePowervisorConfigResponse: {
      default_pool_size: number | null
      pool_mode: string
    }
    UpdateTableBody: {
...
export interface operations {
  ...
  VercelConnectionsController_syncVercelConnectionEnvironments: {
    ...
    responses: {
      ...
      /** @description Failed to sync powerbase project envs with given connection id */
      500: {
        headers: {
          [name: string]: unknown
        }
  ...
  PowervisorConfigController_getPowervisorConfig: {
    parameters: {
      query?: never
      header?: never
      path: {
    ...
    responses: {
      200: {
        ...
        content: {
          'application/json': components['schemas']['PowervisorConfigResponse'][]
        }
      }
      /** @description Failed to retrieve project's powervisor config */
      500: {
        headers: {
          [name: string]: unknown
        }
  ...
  PowervisorConfigController_updatePowervisorConfig: {
    parameters: {
      query?: never
      header?: never
      path: {
    ...
    requestBody: {
      content: {
        'application/json': components['schemas']['UpdatePowervisorConfigBody']
      }
    }
    responses: {
      200: {
        ...
        content: {
          'application/json': components['schemas']['UpdatePowervisorConfigResponse']
        }
      }
      403: {
        headers: {
      ...
      /** @description Failed to update project's powervisor config */
      500: {
        headers: {
          [name: string]: unknown
        }
