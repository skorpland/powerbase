...
export interface paths {
  ...
  '/v1/projects/{ref}/config/database/pooler': {
    ...
    get: operations['getPowervisorConfig']
    put?: never
    post?: never
    delete?: never
    options?: never
    ...
    patch: operations['updatePowervisorConfig']
    trace?: never
  }
  ...
  '/v1/projects/{ref}/types/typescript': {
     ...
     * @description Returns the TypeScript types of your schema for use with powerbase-js.
     */
...
export interface components {
  schemas: {
    ...
    CreateSecretBody: {
      /**
       * @description Secret name must not start with the POWERBASE_ prefix.
       * @example string
       */
      name: string
      value: string
    ...
    V1CreateProjectBodyDto: {
       ...
       * @example https://github.com/skorpland/powerbase/tree/master/examples/slack-clone/nextjs-slack-clone
       */
      template_url?: string
    }
    V1DatabaseResponse: {
