...
const questions = [
  'How do I get started with Powerbase?',
  'How do I run Powerbase locally?',
...
function PromptInput({
  ...
  const setQuery = useSetQuery()
  // If the user has already typed something when they select Powerbase AI, we want to
  ...
  return (
    <CommandInput
      ...
      placeholder={
        isLoading || isResponding ? 'Waiting on an answer...' : 'Ask Powerbase AI a question...'
      }
      value={inputValue}
  ...
  return (
    <div className="p-6 flex flex-col items-center gap-2 mt-4">
      ...
      <p className="text-sm text-foreground text-center">
        Sorry, looks like Powerbase AI is having a hard time!
      </p>
