...
import { someFilter } from '@skorpland/sql-to-rest'
...
export const faqs: Faq[] = [
  ...
  {
    id: 'what-is-powerbase-js',
    condition: (result) => result.language === 'js',
    question: 'What library is this?',
    answer: stripIndent`
      This snippet uses [\`powerbase-js\`](https://github.com/skorpland/powerbase-js), a JavaScript/TypeScript client that provides a convenient SDK wrapper around your project's API.
  ...
  },
  {
    ...
    answer: stripIndent`
      [\`powerbase-js\`](https://github.com/skorpland/powerbase-js) supports \`limit()\` but not \`offset()\`.
