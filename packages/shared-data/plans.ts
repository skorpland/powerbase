...
export const plans: PricingInformation[] = [
  {
    ...
    nameBadge: '',
    costUnit: '/ month',
    href: 'https://powerbase.club/dashboard/new?plan=free',
    priceLabel: '',
    priceMonthly: 0,
  ...
  },
  {
    ...
    costUnit: '/ month',
    href: 'https://powerbase.club/dashboard/new?plan=pro',
    priceLabel: 'From',
  ...
  },
  {
    ...
    nameBadge: '',
    costUnit: '/ month',
    href: 'https://powerbase.club/dashboard/new?plan=team',
    priceLabel: 'From',
    warning: '$10 in compute credits included',
    priceMonthly: 599,
  ...
  },
  {
    id: 'tier_enterprise',
    name: 'Enterprise',
    href: 'https://forms.powerbase.club/enterprise',
