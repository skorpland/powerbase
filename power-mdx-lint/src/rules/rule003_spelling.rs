...
///    ```markdown
///    {/* power-mdx-lint-configure Rule003Spelling +Powerbase */}
///    {/* power-mdx-lint-configure-next-line Rule003Spelling +pgTAP */}
///    ```
/// 4. You can disable the rule by using one of the disable directives. This should be used as a last resort.
///    ```markdown
///    {/* power-mdx-lint-disable Rule003Spelling */}
///    {/* power-mdx-lint-disable-next-line Rule003Spelling */}
///    ```
///
/// ## Examples
///
...
impl Rule003Spelling {
    ...
    /// ## Examples
    ///
    /// 1. Allows "Powerbase" for the rest of the file:
    ///    ```mdx
    ///    {/* power-mdx-lint-configure Rule003Spelling +Powerbase */}
    ///    ```
    /// 1. Allows "Powerbase" for the next line:
    ///    ```mdx
    ///    {/* power-mdx-lint-configure-next-line Rule003Spelling +Powerbase */}
    ///    ```
