...
const defaultEnv = {
  ...
  // POWERBASE_REST_URL: 'http://127.0.0.1:54321/rest/v1/',
  // NEXT_PUBLIC_ENABLE_LOGS: 'false',
  // NEXT_PUBLIC_IS_PLATFORM: 'false',
  POWERBASE_ANON_KEY: '$ANON_KEY',
  POWERBASE_SERVICE_KEY: '$SERVICE_ROLE_KEY',
  POWERBASE_URL: '$API_URL',
  STUDIO_PG_META_URL: '$API_URL/pg',
  POWERBASE_PUBLIC_URL: '$API_URL',
  SENTRY_IGNORE_API_RESOLUTION_ERROR: '1',
  LOGFLARE_URL: 'http://localhost:54329',
  LOGFLARE_API_KEY: 'api-key',
  NEXT_PUBLIC_SITE_URL: 'http://localhost:8082',
  NEXT_PUBLIC_GOTRUE_URL: '$POWERBASE_PUBLIC_URL/auth/v1',
