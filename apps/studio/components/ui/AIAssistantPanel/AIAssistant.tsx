    ...
    <>
        ...
        <div ref={scrollContainerRef} className={cn('flex-grow overflow-auto flex flex-col')}>
          ...
          {hasMessages ? (
            ...
            <div className="w-full flex flex-col justify-end flex-1 h-full p-5">
              <h2 className="text-base mb-2">Welcome to Powerbase!</h2>
              <p className="text-sm text-foreground-lighter mb-6">
                This is the Powerbase assistant which will help you create, debug and modify tables,
      ...
      >
        <p className="text-sm text-foreground-light">
          By opting into sending anonymous data, Powerbase AI can improve the answers it shows you.
