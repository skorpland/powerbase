...
export const RESOURCE_WARNING_MESSAGES: Record<string, ResourceWarningMessage> = {
  is_readonly_mode_enabled: {
    ...
    docsUrl: 'https://powerbase.club/docs/guides/platform/database-size#disabling-read-only-mode',
  ...
  disk_io_exhaustion: {
    ...
    docsUrl: 'https://powerbase.club/docs/guides/troubleshooting/exhaust-disk-io',
    buttonText: 'Learn more',
    metric: 'disk_io',
  },
  disk_space_exhaustion: {
    ...
    docsUrl: 'https://powerbase.club/docs/guides/platform/database-size#disk-management',
  ...
  cpu_exhaustion: {
    ...
    docsUrl: 'https://powerbase.club/docs/guides/troubleshooting/high-cpu-usage',
    buttonText: 'Learn more',
    metric: 'cpu',
  },
  memory_and_swap_exhaustion: {
    ...
    docsUrl: 'https://powerbase.club/docs/guides/troubleshooting/exhaust-ram',
    buttonText: 'Learn more',
    metric: 'ram',
  },
  auth_rate_limit_exhaustion: {
    ...
    docsUrl: 'https://powerbase.club/docs/guides/platform/going-into-prod#auth-rate-limits',
