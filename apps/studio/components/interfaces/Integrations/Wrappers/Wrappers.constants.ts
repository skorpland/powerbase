...
export const WRAPPERS: WrapperMeta[] = [
  {
    ...
    label: 'Stripe',
    docsUrl: 'https://powerbase.club/docs/guides/database/extensions/wrappers/stripe',
    server: {
      options: [
        {
          name: 'api_key_id',
  ...
  },
  {
    ...
    label: 'Firebase',
    docsUrl: 'https://powerbase.club/docs/guides/database/extensions/wrappers/firebase',
    server: {
      options: [
        {
          name: 'project_id',
  ...
  },
  {
    ...
    extensionName: 'S3Fdw',
    label: 'S3',
    docsUrl: 'https://powerbase.club/docs/guides/database/extensions/wrappers/s3',
    server: {
      options: [
        {
  ...
  },
  {
    ...
    label: 'ClickHouse',
    docsUrl: 'https://powerbase.club/docs/guides/database/extensions/wrappers/clickhouse',
    server: {
      options: [
        {
          name: 'conn_string_id',
  ...
  },
  {
    ...
    label: 'BigQuery',
    docsUrl: 'https://powerbase.club/docs/guides/database/extensions/wrappers/bigquery',
    server: {
      options: [
        {
          name: 'sa_key_id',
  ...
  },
  {
    ...
    label: 'Airtable',
    docsUrl: 'https://powerbase.club/docs/guides/database/extensions/wrappers/airtable',
    server: {
      options: [
        {
          name: 'api_key_id',
  ...
  },
  {
    ...
    label: 'Logflare',
    docsUrl: 'https://powerbase.club/docs/guides/database/extensions/wrappers/logflare',
    server: {
      options: [
        {
          name: 'api_key_id',
  ...
  },
  {
    ...
    label: 'Auth0',
    docsUrl: 'https://powerbase.club/docs/guides/database/extensions/wrappers/auth0',
  ...
  },
  {
    ...
    label: 'Cognito',
    docsUrl: 'https://powerbase.club/docs/guides/database/extensions/wrappers/cognito',
    minimumExtensionVersion: '0.3.0',
    server: {
      options: [
        {
  ...
  },
  {
    ...
    docsUrl: 'https://powerbase.club/docs/guides/database/extensions/wrappers/mssql',
    minimumExtensionVersion: '0.3.0',
    server: {
      options: [
        {
  ...
  },
  {
    ...
    label: 'Redis',
    docsUrl: 'https://powerbase.club/docs/guides/database/extensions/wrappers/redis',
    minimumExtensionVersion: '0.3.0',
    server: {
      options: [
        {
  ...
  },
  {
    ...
    label: 'Paddle',
    docsUrl: 'https://powerbase.club/docs/guides/database/extensions/wrappers/paddle',
      ...
      options: [
        {
          ...
          secureEntry: false,
          defaultValue:
            'https://github.com/skorpland/wrappers/releases/download/wasm_paddle_fdw_v0.1.1/paddle_fdw.wasm',
          hidden: true,
        },
        {
          ...
          encrypted: false,
          secureEntry: false,
          defaultValue: 'powerbase:paddle-fdw',
          hidden: true,
        },
        {
  ...
  },
  {
    ...
    label: 'Snowflake',
    docsUrl: 'https://powerbase.club/docs/guides/database/extensions/wrappers/snowflake',
    minimumExtensionVersion: '0.4.0',
    server: {
      options: [
        {
          ...
          secureEntry: false,
          defaultValue:
            'https://github.com/skorpland/wrappers/releases/download/wasm_snowflake_fdw_v0.1.1/snowflake_fdw.wasm',
          hidden: true,
        },
        {
          name: 'fdw_package_name',
          ...
          encrypted: false,
          secureEntry: false,
          defaultValue: 'powerbase:snowflake-fdw',
          hidden: true,
        },
        {
          name: 'fdw_package_version',
  ...
  },
  {
    ...
    label: 'Cal.com',
    docsUrl: 'https://powerbase.club/docs/guides/database/extensions/wrappers/cal',
    minimumExtensionVersion: '0.4.0',
    server: {
      options: [
        {
          ...
          secureEntry: false,
          defaultValue:
            'https://github.com/skorpland/wrappers/releases/download/wasm_cal_fdw_v0.1.0/cal_fdw.wasm',
          hidden: true,
        },
        {
          name: 'fdw_package_name',
          ...
          encrypted: false,
          secureEntry: false,
          defaultValue: 'powerbase:cal-fdw',
          hidden: true,
        },
        {
          name: 'fdw_package_version',
  ...
  },
  {
    ...
    label: 'Calendly',
    docsUrl: 'https://powerbase.club/docs/guides/database/extensions/wrappers/calendly',
    minimumExtensionVersion: '0.4.0',
    server: {
      options: [
        {
          ...
          secureEntry: false,
          defaultValue:
            'https://github.com/skorpland/wrappers/releases/download/wasm_calendly_fdw_v0.1.0/calendly_fdw.wasm',
          hidden: true,
        },
        {
          name: 'fdw_package_name',
          ...
          encrypted: false,
          secureEntry: false,
          defaultValue: 'powerbase:calendly-fdw',
          hidden: true,
        },
        {
          name: 'fdw_package_version',
  ...
  },
  {
    ...
    label: 'Clerk',
    docsUrl: 'https://powerbase.club/docs/guides/database/extensions/wrappers/clerk',
    minimumExtensionVersion: '0.4.0',
    server: {
      options: [
        {
          ...
          secureEntry: false,
          defaultValue:
            'https://github.com/skorpland/wrappers/releases/download/wasm_clerk_fdw_v0.1.0/clerk_fdw.wasm',
          hidden: true,
        },
        {
          name: 'fdw_package_name',
          ...
          encrypted: false,
          secureEntry: false,
          defaultValue: 'powerbase:clerk-fdw',
          hidden: true,
        },
        {
          name: 'fdw_package_version',
      ...
      options: [
        {
          ...
          secureEntry: false,
          defaultValue:
            'https://github.com/skorpland/wrappers/releases/download/wasm_notion_fdw_v0.1.1/notion_fdw.wasm',
          hidden: true,
        },
        {
          name: 'fdw_package_name',
          ...
          encrypted: false,
          secureEntry: false,
          defaultValue: 'powerbase:notion-fdw',
          hidden: true,
        },
        {
          name: 'fdw_package_version',
