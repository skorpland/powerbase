...
const authorPowerbase = {
  name: 'Powerbase',
  websiteUrl: 'https://powerbase.club',
}

const powerbaseIntegrations: IntegrationDefinition[] = [
  {
    id: 'queues',
  ...
  },
  {
    id: 'vault',
    type: 'postgres_extension' as const,
    requiredExtensions: ['powerbase_vault'],
    ...
    docsUrl: 'https://powerbase.club/docs',
    author: authorPowerbase,
    navigation: [
      {
        route: 'overview',
        label: 'Overview',
...
const wrapperIntegrations: IntegrationDefinition[] = WRAPPERS.map((w) => {
  return {
    ...
    requiredExtensions: ['wrappers', 'powerbase_vault'],
