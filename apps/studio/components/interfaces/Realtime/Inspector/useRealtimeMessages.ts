import { RealtimeChannel, RealtimeClient } from '@skorpland/realtime-js'
import {
  DEFAULT_GLOBAL_OPTIONS,
  DEFAULT_REALTIME_OPTIONS,
} from '@skorpland/powerbase-js/dist/main/lib/constants'
...
export const useRealtimeMessages = (
  ...
  const host = settings ? `${protocol}://${endpoint}` : `https://${projectRef}.powerbase.club`
