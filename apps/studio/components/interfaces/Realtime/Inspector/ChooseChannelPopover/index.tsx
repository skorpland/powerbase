              ...
              <Form_Shadcn_ {...form}>
                ...
                >
                    ...
                    render={({ field }) => (
                      <FormItem_Shadcn_ className="flex flex-col gap-y-2">
                        ...
                        <FormDescription_Shadcn_ className="text-xs text-foreground-lighter">
                          The channel you initialize with the Powerbase Realtime client. Learn more
                          in{' '}
                          <a
                            target="_blank"
                            rel="noreferrer"
                            className="underline hover:text-foreground transition"
                            href="https://powerbase.club/docs/guides/realtime/concepts#channels"
                          >
                            our docs
                          </a>
                        </FormDescription_Shadcn_>
                  ...
                  <DocsButton
                    abbrev={false}
                    className="w-min"
                    href="https://powerbase.club/docs/guides/realtime/authorization"
                  />
                </form>
              </Form_Shadcn_>
            </>
