...
const Introduction = ({ showKeys, language, apikey, endpoint }: ContentProps) => {
  ...
  return (
    <>
        ...
        <div className="px-4 space-y-6">
            ...
            <Input
              ...
              actions={[
                <Button
                  ...
                  onClick={() => {
                    setCopied('anon')
                    copyToClipboard(anonApiKey ?? 'POWERBASE_CLIENT_ANON_KEY')
                  }}
                >
          ...
          <div className="flex space-x-4">
            ...
            <Input
              ...
              value={
                showKeys
                  ? serviceApiKey ?? 'POWERBASE_CLIENT_SERVICE_KEY'
      ...
      <ContentSnippet
        selectedLanguage={language}
        apikey={showKeys ? serviceApiKey : 'POWERBASE_CLIENT_SERVICE_KEY'}
        endpoint={endpoint}
