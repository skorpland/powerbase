...
You will be able to connect a GitHub repository to a Powerbase project.
...
`
  ...
  const GitHubContentSectionBottom = gitHubAuthorization
    ? `You are authorized with Powerbase GitHub App. You can configure your GitHub App installations and repository access [here](${GITHUB_INTEGRATION_INSTALLATION_URL}). You can revoke your authorization [here](${GITHUB_INTEGRATION_REVOKE_AUTHORIZATION_URL}).`
    : ''
                ...
                {connections?.map((connection) => (
                  <IntegrationConnectionItem
                    ...
                    connection={{
                      ...
                      powerbase_project_ref: connection.project.ref,
