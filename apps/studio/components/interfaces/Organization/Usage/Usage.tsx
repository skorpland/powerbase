      ...
      {selectedProjectRef ? (
        <ScaffoldContainer className="mt-5">
          <Admonition
            ...
            description={`You are currently viewing usage for the "${selectedProject?.name || selectedProjectRef}" project. Powerbase uses organization-level billing and quotas. For billing purposes, we sum up usage from
                  all your projects. To view your usage quota, set the project filter above back to
                  "All Projects".`}
          >
            <DocsButton
              abbrev={false}
              href="https://powerbase.club/docs/guides/platform/billing-on-powerbase#organization-based-billing"
            />
          </Admonition>
        </ScaffoldContainer>
      ) : (
