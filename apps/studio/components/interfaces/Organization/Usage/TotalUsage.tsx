          ...
          links: [
            {
              ...
              url: 'https://powerbase.club/docs/guides/platform/billing-on-powerbase',
            },
            {
              name: 'Powerbase Plans',
              url: 'https://powerbase.club/pricing',
            },
          ],
        }}
      >
              ...
              <p className="text-sm">
                {!hasExceededAnyLimits ? (
                  ...
                  <span>
                    ...
                    <span className="font-medium">{subscription?.plan.name}</span> Plan quota in
                    this billing cycle. Upgrade your plan to continue using Powerbase without
                    restrictions.
                  </span>
                ) : hasExceededAnyLimits &&
                  ...
                  <span>
                    You have exceeded your{' '}
                    <span className="font-medium">{subscription?.plan.name}</span> Plan quota in
                    this billing cycle. Disable your spend cap to continue using Powerbase without
                    restrictions.
                  </span>
