    ...
    attributes: [
      {
        ...
        attributes: [
          ...
          { key: EgressType.POWERVISOR, name: 'Shared Pooler Egress', color: 'red' },
    ...
    attributes: [
      subscription?.plan.id === 'free'
        ? {
            ...
            links: [
              {
                name: 'Documentation',
                url: 'https://powerbase.club/docs/guides/platform/database-size',
              },
            ],
            chartDescription: 'The data refreshes every 24 hours.',
        ...
        : {
            ...
            unit: 'bytes',
            description:
              "Each Powerbase project comes with a dedicated disk. Each project gets 8 GB of disk for free. Billing is based on the provisioned disk size. Disk automatically scales up when you get close to it's size.\nEach hour your project is using more than 8 GB of GP3 disk, it incurs the overages in GB-Hrs, i.e. a 16 GB disk incurs 8 GB-Hrs every hour. Extra disk size costs $0.125/GB/month ($0.000171/GB-Hr).",
            links: [
              {
                name: 'Documentation',
                url: 'https://powerbase.club/docs/guides/platform/manage-your-usage/disk-size',
              },
              {
                name: 'Disk Management',
                url: 'https://powerbase.club/docs/guides/platform/database-size#disk-management',
              },
            ],
            chartDescription: '',
          },
      {
        ...
        links: [
          {
            name: 'Storage',
            url: 'https://powerbase.club/docs/guides/storage',
          },
        ],
      },
    ],
    ...
    attributes: [
      {
        ...
        links: [
          {
            name: 'Auth',
            url: 'https://powerbase.club/docs/guides/auth',
          },
        ],
      },
      {
        ...
        links: [
          {
            ...
            url: 'https://powerbase.club/docs/guides/auth/sso/auth-sso-saml',
          },
        ],
      },
      {
        ...
        links: [
          {
            name: 'Documentation',
            url: 'https://powerbase.club/docs/guides/storage/image-transformations',
          },
        ],
      },
      {
        ...
        links: [
          {
            name: 'Edge Functions',
            url: 'https://powerbase.club/docs/guides/functions',
          },
        ],
      },
      {
        ...
        links: [
          {
            ...
            url: 'https://powerbase.club/docs/guides/realtime/quotas',
          },
        ],
      },
      {
