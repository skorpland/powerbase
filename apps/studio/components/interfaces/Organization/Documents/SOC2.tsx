    ...
    <ScaffoldSection>
      ...
      <ScaffoldSectionContent>
        ...
        <ConfirmationModal
          visible={isOpen}
          size="large"
          title="Non-Disclosure Agreement to access Powerbase's SOC2 Report"
        ...
        >
          <ol className="list-decimal list-inside text-sm text-foreground-light pl-30">
            ...
            <li>
              ...
              contained in the agreement between Powerbase, Inc ("Powerbase", "we", "our" or "us") and
              the Powerbase customer that has authorized you to access our platform to obtain this
