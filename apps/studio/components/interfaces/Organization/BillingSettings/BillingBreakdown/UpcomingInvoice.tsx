...
const feeTooltipData: TooltipData[] = [
  {
    ...
    linkRef: 'https://powerbase.club/docs/guides/platform/manage-your-usage/compute',
  },
]
                ...
                <tr className="border-b">
                  <td className="py-2 text-sm max-w-[200px]">
                    ...
                    <InvoiceTooltip
                      ...
                      linkRef="https://powerbase.club/docs/guides/platform/manage-your-usage/compute#compute-credits"
                    />
                  </td>
