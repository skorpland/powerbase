...
>(({ closable = false, removeBorder = false, ...props }, ref) => {
  ...
  const commands: Commands[] = [
    {
      command: 'powerbase functions new hello-world',
      description: ' creates a function stub at ./functions/hello-world/index.ts',
      jsx: () => {
        return (
          <>
            <span className="text-brand-600">powerbase</span> functions new hello-world
          </>
        )
      },
    ...
    {
      command: `powerbase functions deploy hello-world --project-ref ${projectRef}`,
      description: 'Deploys function at ./functions/hello-world/index.ts',
      jsx: () => {
        return (
          <>
            <span className="text-brand-600">powerbase</span> functions deploy hello-world
    ...
    {
      command: `curl -L -X POST 'https://${projectRef}.powerbase.${restUrlTld}/functions/v1/hello-world' -H 'Authorization: Bearer ${
        ...
        {tokens && tokens.length === 0 ? (
          ...
          <div className="py-4 space-y-3 border-t">
            ...
            <div className="flex gap-2">
              <DocsButton href="https://powerbase.club/docs/guides/functions" />
              <Button asChild type="default" icon={<ExternalLink />}>
                <a
                  target="_blank"
                  rel="noreferrer"
                  href="https://github.com/skorpland/powerbase/tree/master/examples/edge-functions/powerbase/functions"
                >
                  Examples
                </a>
              </Button>
