          ...
          <div className="rounded border bg-surface-100 px-6 py-4 drop-shadow-sm">
            <div className="space-y-6">
              <CommandRender
                commands={[
                  {
                    command: `powerbase functions download ${selectedFunction?.slug}`,
                    description: 'Download the function to your local machine',
                    jsx: () => (
                      <>
                        <span className="text-brand-600">powerbase</span> functions download{' '}
                ...
                <dl className="grid grid-cols-1 xl:grid-cols-[auto_1fr] gap-y-4 xl:gap-y-6 gap-x-10">
                  ...
                  <dd className="text-sm lg:text-left">
                    ...
                    <div className="mt-4">
                      ...
                      >
                        <Link
                          href="https://powerbase.club/docs/guides/functions/dependencies"
                          target="_blank"
                          rel="noreferrer"
                        >
