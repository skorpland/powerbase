          ...
          <NoticeBar
            ...
            description={
              isBranch
                ...
                : 'The Fly Postgres offering is deprecated - please migrate your instance to Powerbase to configure your disk.'
            }
          />
          {!isFlyArchitecture && (
            <>
                ...
                {!isReadOnlyMode && usedPercentage >= 90 && isWithinCooldownWindow && (
                  ...
                  >
                    <DocsButton
                      abbrev={false}
                      className="mt-2"
                      href="https://powerbase.club/docs/guides/platform/database-size#read-only-mode"
                    />
                  </Admonition>
                )}
                {isReadOnlyMode && (
                  ...
                  >
                    <DocsButton
                      abbrev={false}
                      className="mt-2"
                      href="https://powerbase.club/docs/guides/platform/database-size#disabling-read-only-mode"
                    />
                  </Admonition>
                )}
              </div>
