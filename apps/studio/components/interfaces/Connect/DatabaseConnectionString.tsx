 ...
 * So session mode connection details are always using the shared pooler (Powervisor)
 */
export const DatabaseConnectionString = () => {
  ...
  const {
    data: powervisorConfig,
    error: powervisorConfigError,
    isLoading: isLoadingPowervisorConfig,
    isError: isErrorPowervisorConfig,
    isSuccess: isSuccessPowervisorConfig,
  } = usePowervisorConfigurationQuery({ projectRef })
  ...
  const sharedPoolerConfig = powervisorConfig?.find((x) => x.identifier === state.selectedDatabaseId)
  ...
  const powervisorConnectionStrings = getConnectionStrings({
    connectionInfo,
    poolingInfo: {
  ...
  const connectionStrings =
    isSuccessPowervisorConfig && poolingConfiguration !== undefined
          ...
          <div>
            ...
            <div className="divide-y divide-border-muted [&>div]:px-4 [&>div]:md:px-7 [&>div]:py-8">
                  ...
                  <Collapsible_Shadcn_ className="group">
                    ...
                    <CollapsibleContent_Shadcn_ className="bg-dash-sidebar rounded-b border text-xs">
                      ...
                      <CodeBlock
                        ...
                        language={lang}
                        value={powervisorConnectionStrings['pooler'][selectedTab]}
                        className="[&_code]:text-[12px] [&_code]:text-foreground"
                        hideLineNumbers
                        onCopyCallback={() => handleCopy(selectedTab, 'transaction_pooler')}
                      />
              ...
              <ConnectionPanel
                ...
                connectionString={powervisorConnectionStrings['pooler'][selectedTab].replace(
                  '6543',
                  '5432'
                )}
                ipv4Status={{
