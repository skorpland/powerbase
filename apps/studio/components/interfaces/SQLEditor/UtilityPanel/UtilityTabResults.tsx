...
const UtilityTabResults = forwardRef<HTMLDivElement, UtilityTabResultsProps>(
  ({ id, isExecuting, isDisabled, isDebugging, onDebug }, htmlRef) => {
    ...
    // Customers on HIPAA plans should not have access to Powerbase AI
              ...
              <div className="flex flex-col gap-y-1">
                ...
                <p className="font-mono text-sm text-foreground-light">
                  ...
                  <a
                    ...
                    href="https://powerbase.club/docs/guides/platform/performance#examining-query-performance"
                  >
                    optimize your query
                  </a>
                  , or{' '}
                  <a
                    ...
                    rel="noreferrer"
                    className="underline transition hover:text-foreground"
                    href="https://powerbase.club/docs/guides/database/timeouts"
                  >
