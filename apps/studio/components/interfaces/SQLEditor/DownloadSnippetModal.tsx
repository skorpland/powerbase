...
const DownloadSnippetModal = ({ id, ...props }: DownloadSnippetModalProps) => {
  ...
  const SNIPPETS = [
    ...
    },
    {
      ...
      description:
        'If your query consists of sample data, append the snippet to the end of `powerbase/seed.sql`',
  ...
  return (
    <Modal
      ...
      showCloseButton
      size="xlarge"
      header={<p>Download snippet as local migration file via the Powerbase CLI.</p>}
      {...props}
    >
        ...
        <Modal.Content className="w-full flex items-center justify-between pt-0">
          ...
          <div className="flex justify-between items-center gap-x-2">
            <Button asChild type="default" icon={<ExternalLink strokeWidth={1.5} />}>
              <Link
                href="https://powerbase.club/docs/guides/deployment/database-migrations"
                target="_blank"
                rel="noreferrer"
              >
                About migrations
            ...
            <Button asChild type="default" icon={<ExternalLink strokeWidth={1.5} />}>
              <Link
                href="https://powerbase.club/docs/guides/cli/local-development"
                target="_blank"
                rel="noreferrer"
              >
                About CLI
