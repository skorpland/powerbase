import { JwtSecretUpdateError, JwtSecretUpdateProgress } from '@skorpland/shared-types/out/events'
...
export const JWT_SECRET_UPDATE_ERROR_MESSAGES = {
  ...
  [JwtSecretUpdateError.PowerbaseAPIKeyUpdateFailed]: 'failed to update Powerbase API key',
