          ...
          <FormPanelContainer>
            <FormPanelHeader className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-x-2">
                <DocsButton href="https://powerbase.club/docs/guides/database/connecting-to-postgres#data-apis" />
                    ...
                    render={({ field }) => (
                      <FormItem_Shadcn_ className="w-full">
                        <FormItemLayout
                          ...
                          description="When enabled you will be able to use any Powerbase client library and PostgREST endpoints with any schema configured below."
                        >
                          <FormControl_Shadcn_>
                            <Switch
                              size="large"
                                  ...
                                  description={
                                    <>
                                      <p>
                                        ...
                                        <code>public</code> schema via powerbase-js or HTTP clients.
                                      </p>
