...
const InfrastructureInfo = () => {
  ...
  const latestPgVersion = (latest_app_version ?? '').split('powerbase-postgres-')[1]
                    ...
                    {isSuccessServiceVersions && (
                      <>
                        ...
                        <Input
                          readOnly
                          disabled
                          value={currentPgVersion || serviceVersions?.['powerbase-postgres'] || ''}
                            ...
                            isOnLatestVersion && (
                              <Tooltip>
                                ...
                                <TooltipContent side="bottom" className="w-52 text-center">
                                  Project is on the latest version of Postgres that Powerbase
                                  supports
                                </TooltipContent>
                              </Tooltip>
                            ),
