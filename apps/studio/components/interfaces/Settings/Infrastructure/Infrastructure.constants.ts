        ...
        links: [
          {
            ...
            url: 'https://powerbase.club/docs/guides/platform/compute-add-ons',
          },
          {
            name: 'High CPU Usage',
            url: 'https://powerbase.club/docs/guides/troubleshooting/high-cpu-usage',
          },
          {
            name: 'Metrics',
            url: 'https://powerbase.club/docs/guides/platform/metrics',
          },
        ],
      },
      {
        ...
        links: [
          ...
          {
            name: 'High RAM Usage',
            url: 'https://powerbase.club/docs/guides/troubleshooting/exhaust-ram',
          },
          {
            name: 'Metrics',
            url: 'https://powerbase.club/docs/guides/platform/metrics',
        ...
        links: [
          {
            ...
            url: 'https://powerbase.club/docs/guides/platform/compute-add-ons#disk-throughput-and-iops',
          },
          {
            name: 'High Disk I/O',
            url: 'https://powerbase.club/docs/guides/troubleshooting/exhaust-disk-io',
          },
          {
            name: 'Metrics',
            url: 'https://powerbase.club/docs/guides/platform/metrics',
