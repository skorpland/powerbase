...
const DeployNewReplicaPanel = ({
  ...
  const currentPgVersion = Number(
    (project?.dbVersion ?? '').split('powerbase-postgres-')[1]?.split('.')[0]
  )
          ...
          <Alert_Shadcn_>
            ...
            <AlertDescription_Shadcn_>
              ...
              <DocsButton
                abbrev={false}
                className="mt-3"
                href="https://powerbase.club/docs/guides/platform/read-replicas#prerequisites"
              />
            </AlertDescription_Shadcn_>
          </Alert_Shadcn_>
        ) : currentPgVersion < 15 ? (
          ...
          <Alert_Shadcn_>
            ...
            {refetchInterval !== false ? (
              ...
              <AlertDescription_Shadcn_ className="flex items-center gap-x-2 mt-3">
                ...
                <DocsButton
                  abbrev={false}
                  href="https://powerbase.club/docs/guides/platform/read-replicas#how-are-read-replicas-made"
                />
              </AlertDescription_Shadcn_>
            )}
          </Alert_Shadcn_>
        ...
        <div className="flex flex-col gap-y-6 mt-2">
          ...
          <div className="flex flex-col gap-y-2">
            ...
            <p className="text-foreground-light text-sm">
              Read more about{' '}
              <Link
                href="https://powerbase.club/docs/guides/platform/manage-your-usage/read-replicas"
                target="_blank"
                rel="noreferrer"
