...
Connect your Vercel teams to your Powerbase organization.
`
...
Powerbase will keep your environment variables up to date in each of the projects you assign to a Powerbase project.
You can also link multiple Vercel Projects to the same Powerbase project.
`
...
You can change the scope of the access for Powerbase by configuring
...
`
  ...
  const integrationUrl =
    process.env.NEXT_PUBLIC_ENVIRONMENT === 'prod'
      ? 'https://vercel.com/integrations/powerbase'
      : process.env.NEXT_PUBLIC_ENVIRONMENT === 'staging'
        ? `https://vercel.com/integrations/powerbase-staging`
        : 'https://vercel.com/integrations/powerbase-local'

  let connections =
    (isProjectScoped
      ? vercelIntegration?.connections.filter(
          (connection) => connection.powerbase_project_ref === project?.ref
        )
