...
const ProjectUpgradeAlert = () => {
  ...
  const currentPgVersion = (data?.current_app_version ?? '').split('powerbase-postgres-')[1]
  const latestPgVersion = (data?.latest_app_version ?? '').split('powerbase-postgres-')[1]
              ...
              <div className="space-y-4">
                ...
                {isDiskSizeUpdated && (
                  <Markdown
                    ...
                    [right-sized](https://powerbase.club/docs/guides/platform/upgrading#disk-sizing) with the upgrade.`}
                  />
                )}
                    ...
                    <AlertDescription_Shadcn_ className="flex flex-col gap-3">
                      ...
                      <div>
                        <Button size="tiny" type="default" asChild>
                          <Link
                            href="https://powerbase.club/docs/guides/platform/migrating-and-upgrading-projects#caveats"
                            target="_blank"
                            rel="noreferrer"
                          >
                            View docs
                            ...
                            <SelectGroup_Shadcn_>
                              {(data?.target_upgrade_versions || [])?.map((value) => {
                                const postgresVersion =
                                  value.app_version.split('powerbase-postgres-')[1]
                                return (
                                  <SelectItem_Shadcn_
