      ...
      <Panel
        ...
        title={
          <div className="w-full flex items-center justify-between">
            ...
            <DocsButton href="https://powerbase.club/docs/guides/database/connecting-to-postgres#connection-pooler" />
          </div>
        }
        footer={
          <FormActions
                    ...
                    <FormItemLayout
                      ...
                      description={
                        <>
                          ...
                          <p className="mt-2">
                            Please refer to our{' '}
                            <InlineLink href="https://powerbase.club/docs/guides/database/connection-management#configuring-powervisors-pool-size">
                              documentation
                            </InlineLink>{' '}
                            to find out more.
                          </p>
