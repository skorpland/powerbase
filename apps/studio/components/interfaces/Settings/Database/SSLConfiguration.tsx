  ...
  return (
    <div id="ssl-configuration">
      <div className="flex items-center justify-between mb-6">
        ...
        <DocsButton href="https://powerbase.club/docs/guides/platform/ssl-enforcement" />
      </div>
      <FormPanel>
        <FormSection
          header={
          ...
          <div className="flex items-end justify-end">
            {!hasSSLCertificate ? (
              ...
              <Button type="default" icon={<Download />}>
                <a
                  href={`https://powerbase-downloads.s3-ap-southeast-1.amazonaws.com/${env}/ssl/${env}-ca-2021.crt`}
                >
                  Download certificate
                </a>
              </Button>
