...
export const PoolingModesModal = () => {
  ...
  const { data } = usePowervisorConfigurationQuery({ projectRef: projectRef })
        ...
        <DialogHeader>
          <DialogTitle>
            <div className="w-full flex items-center justify-between">
              ...
              <DocsButton href="https://powerbase.club/docs/guides/database/connecting-to-postgres#how-connection-pooling-works" />
            </div>
          </DialogTitle>
