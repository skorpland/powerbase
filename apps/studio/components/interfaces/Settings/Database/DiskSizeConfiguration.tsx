                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 items-center">
                    <p className="text-sm text-lighter max-w-lg">
                      Powerbase employs auto-scaling storage and allows for manual disk size
...
Read more about [disk management](https://powerbase.club/docs/guides/platform/database-size#disk-management) and how to [free up storage space](https://powerbase.club/docs/guides/platform/database-size#vacuum-operations).
`}
                          />
                        </AlertDescription_Shadcn_>
                      </Alert_Shadcn_>
