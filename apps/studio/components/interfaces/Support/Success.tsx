      ...
      {categoriesToShowAdditionalResources.includes(sentCategory) && (
        <>
          ...
          <div className="flex flex-col items-center px-12 space-y-2 text-center">
            ...
            <p className="text-sm text-foreground-light">
              Find the answers you need with fellow developers building with Powerbase by joining our
          ...
          <div className="w-full px-12 !mt-8">
            <Input
              ...
              actions={[
                ...
                >
                  <Link
                    href={`https://github.com/skorpland/powerbase/discussions?discussions_q=${searchValue}`}
                    target="_blank"
                    rel="noreferrer"
                  >
