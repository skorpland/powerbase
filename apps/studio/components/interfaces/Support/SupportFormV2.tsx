                ...
                description={
                  ...
                  INCLUDE_DISCUSSIONS.includes(category) && (
                    <p className="flex items-center gap-x-1">
                      ...
                      <Link
                        key="gh-discussions"
                        href={`https://github.com/orgs/powerbase/discussions?discussions_q=${field.value}`}
                        target="_blank"
                        rel="noreferrer"
            ...
            <FormField_Shadcn_
              ...
              render={({ field }) => (
                <FormItemLayout
                  ...
                  className="px-6"
                  layout="flex"
                  label="Allow Powerbase Support and AI-Assisted Diagnostics access to your project"
                  description={
                    <Collapsible_Shadcn_>
                      <div className="flex items-center gap-x-2">
        ...
        <div className={cn(CONTAINER_CLASSES, 'flex flex-col items-end gap-3 -mt-4')}>
          ...
          <div className="flex flex-col items-end gap-1">
            ...
            <span className="text-foreground-light text-xs">
              Please ensure emails from powerbase.club are allowed
            </span>
          </div>
        </div>
      </form>
