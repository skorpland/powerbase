...
interface HTTPRequestFieldsProps {
  type: 'http_request' | 'powerbase_function'
  errors: any
      ...
      >
        <FormSectionContent loading={false} className="lg:!col-span-8">
          ...
          {type === 'http_request' ? (
            ...
            />
          ) : type === 'powerbase_function' && edgeFunctions.length === 0 ? (
            ...
            <Listbox id="http_url" name="http_url" label="Select which edge function to trigger">
              {edgeFunctions.map((fn) => {
                ...
                const functionUrl = `https://${ref}.powerbase.${restUrlTld}/functions/v1/${fn.slug}`
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center">
              <Button
                ...
                size="tiny"
                icon={<Plus />}
                className={cn(type === 'powerbase_function' && 'rounded-r-none px-3')}
                onClick={onAddHeader}
              >
                Add a new header
              </Button>
                  ...
                  <DropdownMenuContent align="end" side="bottom">
                    ...
                    <DropdownMenuItem
                      ...
                      onClick={() =>
                        onAddHeader({
                          id: uuidv4(),
                          name: 'x-powerbase-webhook-source',
