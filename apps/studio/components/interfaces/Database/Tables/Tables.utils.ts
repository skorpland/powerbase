import { PostgresMaterializedView, PostgresTable, PostgresView } from '@skorpland/postgres-meta'
import { PostgresForeignTable } from '@skorpland/postgres-meta/dist/lib/types'
