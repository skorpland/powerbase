  ...
  const commands = [
    {
      ...
      command: `powerbase link --project-ref ${ref}`,
      jsx: () => {
        return (
          <>
            <span className="text-brand-600">powerbase</span> link --project-ref {ref}
          </>
        )
      },
    },
    {
      ...
      command: `powerbase migration new new-migration`,
      jsx: () => {
        return (
          <>
            <span className="text-brand-600">powerbase</span> migration new new-migration
          </>
        )
      },
    },
    {
      ...
      command: `powerbase db push`,
      jsx: () => {
        return (
          <>
            <span className="text-brand-600">powerbase</span> db push
          </>
        )
      },
    },
      ...
      <div className="space-y-4 md:space-y-8">
        <div className="space-y-2 w-4/5">
          ...
          <p className="text-sm text-foreground-light">
            ...
            database via the Powerbase CLI.
          </p>
        </div>
