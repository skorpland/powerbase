import type { PostgresPublication } from '@skorpland/postgres-meta'
            ...
            <Table
              head={[
                ...
                <Table.th key="header-all">
                  {/* Temporarily disable All tables toggle for publications. See https://github.com/skorpland/powerbase/pull/7233.
