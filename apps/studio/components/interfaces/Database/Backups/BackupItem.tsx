              ...
              content: {
                ...
                text: backup.isPhysicalBackup ? (
                  <>
                    ...
                    <InlineLink href="https://powerbase.club/docs/guides/troubleshooting/download-logical-backups">
                      here
                    </InlineLink>
                    .
                  </>
      ...
      <div className="flex items-center gap-x-2">
        ...
        <Tooltip>
          ...
          <TooltipContent side="bottom">
            ...
            <InlineLink href="https://powerbase.club/blog/postgresql-physical-logical-backups">
              here
            </InlineLink>
          </TooltipContent>
        </Tooltip>
