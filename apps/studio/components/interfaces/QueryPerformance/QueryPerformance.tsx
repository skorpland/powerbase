    ...
    <>
      ...
      >
        ...
        <div className="w-[33%] flex flex-col gap-y-1 text-sm">
          ...
          <Markdown
            className="text-xs"
            content="This report uses the pg_stat_statements table, and pg_stat_statements extension. [Learn more here](https://powerbase.club/docs/guides/platform/performance#examining-query-performance)."
          />
        </div>
        ...
        <div className="w-[33%] flex flex-col gap-y-1 text-sm">
          ...
          <Markdown
            className="text-xs"
            content="The Powerbase CLI comes with a range of tools to help inspect your Postgres instances for
            potential issues. [Learn more here](https://powerbase.club/docs/guides/database/inspect)."
          />
        </div>
      </div>
