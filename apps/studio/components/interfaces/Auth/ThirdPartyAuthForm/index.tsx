      ...
      <div className="flex justify-between gap-4">
        <div>
          ...
          <ScaffoldSectionDescription className="mb-6">
            ...
            <InlineLink href="https://powerbase.club/docs/guides/platform/manage-your-usage/monthly-active-users-third-party">
              billing docs
            </InlineLink>{' '}
        ...
        <div className="flex items-center gap-2 ">
          <DocsButton href="https://powerbase.club/docs/guides/auth/third-party/overview" />
