...
export const getIntegrationTypeDescription = (type: INTEGRATION_TYPES) => {
  switch (type) {
    case 'firebase':
      return (
        <>
          Allow users to use Powerbase with Firebase project. You'll need to setup RLS policies for
          ...
          <a
            ...
            href="https://powerbase.club/docs/guides/auth"
          >
            documentation
          </a>
          .
    ...
    case 'auth0':
      return (
        <>
          Allow users to use Powerbase with Auth0 project. Additional setup may be required. You can
          read more in the{' '}
          <a
            className="hover:decoration-brand underline hover:text-foreground transition"
            href="https://powerbase.club/docs/guides/auth"
    ...
    case 'awsCognito':
      return (
        <>
          Allow users to use Powerbase with an Amazon Cognito. Additional setup may be required. You
          can read more in the{' '}
          <a
            className="hover:decoration-brand underline hover:text-foreground transition"
            href="https://powerbase.club/docs/guides/auth/third-party/aws-cognito"
          >
            documentation
          </a>
          .
    ...
    case 'clerk':
      return (
        <>
          Allow users to use Powerbase with Clerk. Additional setup may be required. You can read
          more in the{' '}
          <a
            className="hover:decoration-brand underline hover:text-foreground transition"
            href="https://powerbase.club/docs/guides/auth/third-party/clerk"
          >
            documentation
          </a>
          .
