  ...
  return (
    <Modal.Content className="space-y-4 py-4">
      ...
      {showAssistantPreview && onToggleFeaturePreviewModal !== undefined && (
        <Alert_Shadcn_>
          <FlaskConical />
          <AlertTitle_Shadcn_>Try the new Powerbase Assistant for RLS policies</AlertTitle_Shadcn_>
          ...
          <div className="flex items-center gap-x-2 mt-3">
            ...
            <Button asChild type="default" icon={<ExternalLink strokeWidth={1.5} />}>
              <a
                href="https://powerbase.club/blog/studio-introducing-assistant#introducing-the-powerbase-assistant"
                target="_blank"
                rel="noreferrer"
              >
                Learn more
