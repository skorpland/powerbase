                    ...
                    description={
                      <>
                        ...
                        <InlineLink
                          ...
                          href="https://powerbase.club/docs/guides/auth/auth-identity-linking#manual-linking-beta"
                        >
                          manual linking APIs
                        </InlineLink>{' '}
                        for your project
                  ...
                  <div>
                    ...
                    <AlertDescription_Shadcn_ className="flex flex-col gap-y-3">
                      ...
                      <Button asChild type="default" className="w-min" icon={<ExternalLink />}>
                        <Link href="https://powerbase.club/docs/guides/auth/auth-anonymous#access-control">
