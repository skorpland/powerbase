...
const PROVIDER_EMAIL = {
  ...
  type: 'object',
  title: 'Email',
  link: 'https://powerbase.club/docs/guides/auth/passwords',
  properties: {
  ...
  misc: {
    ...
    helper: `To complete setup, add this authorisation callback URL to your app's configuration in the Apple Developer Console.
            [Learn more](https://powerbase.club/docs/guides/auth/social-login/auth-apple#configure-your-services-id)`,
  },
}
...
export const PROVIDER_PHONE = {
  ...
  type: 'object',
  title: 'Phone',
  link: 'https://powerbase.club/docs/guides/auth/phone-login',
  properties: {
...
const EXTERNAL_PROVIDER_APPLE = {
  ...
  type: 'object',
  title: 'Apple',
  link: 'https://powerbase.club/docs/guides/auth/social-login/auth-apple',
  properties: {
    ...
    EXTERNAL_APPLE_SECRET: {
      ...
      description: `Secret key used in the OAuth flow. [Learn more](https://powerbase.club/docs/guides/auth/social-login/auth-apple#generate-a-client_secret)`,
      type: 'string',
      isSecret: true,
    },
  },
...
const EXTERNAL_PROVIDER_AZURE = {
  ...
  type: 'object',
  title: 'Azure',
  link: 'https://powerbase.club/docs/guides/auth/social-login/auth-azure',
  properties: {
    ...
    EXTERNAL_AZURE_SECRET: {
      // [TODO] Change docs
      title: 'Secret Value',
      description: `Enter the data from Value, not the Secret ID. [Learn more](https://powerbase.club/docs/guides/auth/social-login/auth-azure#obtain-a-secret-id)`,
      type: 'string',
      isSecret: true,
    },
    EXTERNAL_AZURE_URL: {
...
const EXTERNAL_PROVIDER_BITBUCKET = {
  ...
  type: 'object',
  title: 'Bitbucket',
  link: 'https://powerbase.club/docs/guides/auth/social-login/auth-bitbucket',
  properties: {
...
const EXTERNAL_PROVIDER_DISCORD = {
  ...
  type: 'object',
  title: 'Discord',
  link: 'https://powerbase.club/docs/guides/auth/social-login/auth-discord?',
  properties: {
...
const EXTERNAL_PROVIDER_FACEBOOK = {
  ...
  type: 'object',
  title: 'Facebook',
  link: 'https://powerbase.club/docs/guides/auth/social-login/auth-facebook',
  properties: {
...
const EXTERNAL_PROVIDER_FIGMA = {
  ...
  type: 'object',
  title: 'Figma',
  link: 'https://powerbase.club/docs/guides/auth/social-login/auth-figma',
  properties: {
...
const EXTERNAL_PROVIDER_GITHUB = {
  ...
  type: 'object',
  title: 'GitHub',
  link: 'https://powerbase.club/docs/guides/auth/social-login/auth-github',
  properties: {
...
const EXTERNAL_PROVIDER_GITLAB = {
  ...
  type: 'object',
  title: 'GitLab',
  link: 'https://powerbase.club/docs/guides/auth/social-login/auth-gitlab',
  properties: {
...
const EXTERNAL_PROVIDER_GOOGLE = {
  ...
  type: 'object',
  title: 'Google',
  link: 'https://powerbase.club/docs/guides/auth/social-login/auth-google',
  properties: {
  ...
  misc: {
    ...
    helper: `Register this callback URL when using Sign-in with Google on the web using OAuth.
            [Learn more](https://powerbase.club/docs/guides/auth/social-login/auth-google#configure-your-services-id)`,
  },
}
...
const EXTERNAL_PROVIDER_KAKAO = {
  ...
  type: 'object',
  title: 'Kakao',
  link: 'https://powerbase.club/docs/guides/auth/social-login/auth-kakao',
  properties: {
...
const EXTERNAL_PROVIDER_KEYCLOAK = {
  ...
  type: 'object',
  title: 'KeyCloak',
  link: 'https://powerbase.club/docs/guides/auth/social-login/auth-keycloak',
  properties: {
...
const EXTERNAL_PROVIDER_LINKEDIN_OIDC = {
  ...
  key: 'linkedin_oidc',
  title: 'LinkedIn (OIDC)',
  link: 'https://powerbase.club/docs/guides/auth/social-login/auth-linkedin',
  properties: {
...
const EXTERNAL_PROVIDER_NOTION = {
  ...
  type: 'object',
  title: 'Notion',
  link: 'https://powerbase.club/docs/guides/auth/social-login/auth-notion',
  properties: {
...
const EXTERNAL_PROVIDER_TWITCH = {
  ...
  type: 'object',
  title: 'Twitch',
  link: 'https://powerbase.club/docs/guides/auth/social-login/auth-twitch',
  properties: {
...
const EXTERNAL_PROVIDER_TWITTER = {
  ...
  type: 'object',
  title: 'Twitter',
  link: 'https://powerbase.club/docs/guides/auth/social-login/auth-twitter',
  properties: {
...
const EXTERNAL_PROVIDER_SLACK = {
  ...
  link: 'https://powerbase.club/docs/guides/auth/social-login/auth-slack',
  properties: {
...
const EXTERNAL_PROVIDER_SPOTIFY = {
  ...
  type: 'object',
  title: 'Spotify',
  link: 'https://powerbase.club/docs/guides/auth/social-login/auth-spotify',
  properties: {
...
const EXTERNAL_PROVIDER_WORKOS = {
  ...
  type: 'object',
  title: 'WorkOS',
  link: 'https://powerbase.club/docs/guides/auth/social-login/auth-workos',
  properties: {
...
const EXTERNAL_PROVIDER_ZOOM = {
  ...
  type: 'object',
  title: 'Zoom',
  link: 'https://powerbase.club/docs/guides/auth/social-login/auth-zoom',
  properties: {
...
const PROVIDER_SAML = {
  ...
  type: 'object',
  title: 'SAML 2.0',
  link: 'https://powerbase.club/docs/guides/auth/enterprise-sso/auth-sso-saml',
  properties: {
    SAML_ENABLED: {
      title: 'Enable SAML 2.0 Single Sign-on',
      description:
        'You will need to use the [Powerbase CLI](https://powerbase.club/docs/guides/auth/sso/auth-sso-saml#managing-saml-20-connections) to set up SAML after enabling it',
      type: 'boolean',
    },
    SAML_EXTERNAL_URL: {
