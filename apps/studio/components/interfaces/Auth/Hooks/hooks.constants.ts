export const HOOKS_DEFINITIONS = [
  {
    title: 'Send SMS hook',
    subtitle: 'Will be called by Powerbase Auth each time an SMS message needs to be sent.',
  ...
  },
  {
    ...
    subtitle: 'Will be called by Powerbase Auth each time an email message needs to be sent.',
  ...
  },
  {
    ...
    subtitle:
      'Will be called by Powerbase Auth each time a new JWT is created. It should return the claims you wish to be present in the JWT.',
  ...
  },
  {
    ...
    subtitle:
      'Will be called by Powerbase Auth each time a user tries to verify an MFA factor. Return a decision on whether to reject the attempt and future ones, or to allow the user to keep trying.',
  ...
  },
  {
    ...
    subtitle:
      'Will be called by Powerbase Auth each time a user tries to sign in with a password. Return a decision whether to allow the user to reject the attempt, or to allow the user to keep trying.',
