...
export const CreateHookSheet = ({
  ...
  const statements = useMemo(() => {
    ...
    if (values.postgresValues.functionName !== '') {
      permissionChanges = [
        ...permissionChanges,
        `-- Grant access to function to powerbase_auth_admin\ngrant execute on function ${values.postgresValues.schema}.${values.postgresValues.functionName} to powerbase_auth_admin;`,
        `-- Grant access to schema to powerbase_auth_admin\ngrant usage on schema ${values.postgresValues.schema} to powerbase_auth_admin;`,
                    ...
                    <FormField_Shadcn_
                      ...
                      render={({ field }) => (
                        <FormItemLayout
                          ...
                          description="This function will be called by Powerbase Auth each time the hook is triggered"
                        >
                          <FormControl_Shadcn_>
                            <FunctionSelector
                              size="small"
                ...
                <div className="flex flex-col gap-4 px-5">
                  <FormField_Shadcn_
                    ...
                    render={({ field }) => (
                      <FormItemLayout
                        label="URL"
                        description="Powerbase Auth will send a HTTPS POST request to this URL each time the hook is triggered."
                      >
                        <FormControl_Shadcn_>
                          <Input_Shadcn_ {...field} />
                        </FormControl_Shadcn_>
