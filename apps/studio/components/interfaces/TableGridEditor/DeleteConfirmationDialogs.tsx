import type { PostgresTable } from '@skorpland/postgres-meta'
import { ExternalLink } from 'lucide-react'
import Link from 'next/link'
import { toast } from 'sonner'

import { formatFilterURLParams } from 'components/grid/PowerbaseGrid.utils'
  ...
  const onConfirmDeleteRow = async () => {
    ...
    if (snap.confirmationDialog.allRowsSelected) {
      ...
      deleteRows({
        ...
        connectionString: project.connectionString,
        table: selectedTable as any,
        rows: selectedRowsToDelete as PowerRow[],
        impersonatedRole: getImpersonatedRole(),
      })
    }
  }
