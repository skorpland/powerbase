import type { PostgresColumn, PostgresRelationship, PostgresTable } from '@skorpland/postgres-meta'
import dayjs from 'dayjs'
import { compact, isEqual, isNull, isString, omitBy } from 'lodash'
import type { Dictionary } from 'types'

import { MAX_CHARACTERS } from '@skorpland/pg-meta/src/query/table-row-query'
