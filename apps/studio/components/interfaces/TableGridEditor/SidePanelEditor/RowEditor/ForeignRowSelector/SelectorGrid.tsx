...
const formatter = ({ column, format, row }: { column: string; format: string; row: PowerRow }) => {
...
const SelectorGrid = ({ rows, onRowSelect }: SelectorGridProps) => {
  ...
  const columns: Column<PowerRow>[] = snap.table.columns.map((column) => {
