import type { PostgresColumn, PostgresTable } from '@skorpland/postgres-meta'
...
const SidePanelEditor = ({
  ...
  const updateTableRealtime = async (table: PostgresTable, enabled: boolean) => {
    ...
    let realtimePublication = (publications ?? []).find((pub) => pub.name === 'powerbase_realtime')
