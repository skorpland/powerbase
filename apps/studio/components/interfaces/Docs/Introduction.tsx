    ...
    <>
      ...
      <div className="doc-section">
        <article className="code-column text-foreground">
          ...
          <p>
            You can initialize a new Powerbase client using the <code>createClient()</code> method.
            The Powerbase client is your entrypoint to the rest of the Powerbase functionality and is
            the easiest way to interact with everything we offer within the Powerbase ecosystem.
          </p>
        </article>
