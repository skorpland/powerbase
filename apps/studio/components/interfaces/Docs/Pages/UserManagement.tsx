...
export default function UserManagement({ selectedLang, showApiKey }: UserManagementProps) {
  ...
  const keyToShow = showApiKey ? showApiKey : 'POWERBASE_KEY'
    ...
    <>
      ...
      <div className="doc-section">
        <article className="code-column text-foreground">
          <p>Powerbase makes it easy to manage your users.</p>
          <p>
            Powerbase assigns each user a unique ID. You can reference this ID anywhere in your
            database. For example, you might create a <code>profiles</code> table references the
            user using a <code>user_id</code> field.
          </p>
          <p>
            Powerbase already has built in the routes to sign up, login, and log out for managing
      ...
      <div className="doc-section ">
        <article className="code-column text-foreground">
          ...
          <p>
            After they have signed up, all interactions using the Powerbase JS client will be
      ...
      <div className="doc-section ">
        <article className="code-column text-foreground">
          ...
          <p>
            After they have logged in, all interactions using the Powerbase JS client will be
            performed as "that user".
          </p>
        </article>
        <article className="code">
      ...
      <div className="doc-section ">
        <article className="code-column text-foreground">
          ...
          <p>
            After they have clicked the link, all interactions using the Powerbase JS client will be
            performed as "that user".
          </p>
        </article>
        <article className="code">
      ...
      <div className="doc-section ">
        <article className="code-column text-foreground">
          ...
          <p>
            ...
            <a
              href="https://powerbase.club/docs/guides/auth#providers"
              target="_blank"
              rel="noreferrer"
            >
      ...
      <div className="doc-section ">
        <article className="code-column text-foreground">
          <p>
            After calling log out, all interactions using the Powerbase JS client will be
            "anonymous".
          </p>
        </article>
        <article className="code">
