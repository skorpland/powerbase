...
const Authentication = ({ selectedLang, showApiKey }: AuthenticationProps) => {
  ...
  const defaultApiKey =
    showApiKey !== 'POWERBASE_KEY'
      ? anonKey?.api_key ?? 'POWERBASE_CLIENT_API_KEY'
      : 'POWERBASE_CLIENT_API_KEY'
  const serviceApiKey =
    showApiKey !== 'POWERBASE_KEY'
      ? serviceKey?.api_key ?? 'POWERBASE_SERVICE_KEY'
    ...
    <>
      ...
      <div className="doc-section">
        <article className="code-column text-foreground">
          <p>Powerbase works through a mixture of JWT and Key auth.</p>
          <p>
      ...
      <div className="doc-section">
        <article className="code-column text-foreground">
          ...
          <p>
            In this documentation, we will refer to the key using the name <code>POWERBASE_KEY</code>
            .
          </p>
          <p>
        ...
        <article className="code">
          <CodeSnippet
            ...
            snippet={Snippets.authKey('CLIENT API KEY', 'POWERBASE_KEY', defaultApiKey)}
          />
          <CodeSnippet
            selectedLang={selectedLang}
