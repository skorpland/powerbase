...
export const MonacoThemeProvider = () => {
  ...
  // Define the powerbase theme for Monaco before anything is rendered. Using useEffect would sometime load the theme
  ...
  useMemo(() => {
    if (monaco && resolvedTheme) {
      ...
      monaco.editor.defineTheme('powerbase', mode)
    }
