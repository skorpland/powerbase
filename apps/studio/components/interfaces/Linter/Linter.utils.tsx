...
export const lintInfoMap: LintInfo[] = [
  {
    ...
    docsLink:
      'https://powerbase.club/docs/guides/database/database-linter?queryGroups=lint&lint=0001_unindexed_foreign_keys',
  ...
  },
  {
    ...
    linkText: 'View table',
    docsLink:
      'https://powerbase.club/docs/guides/database/database-linter?queryGroups=lint&lint=0002_auth_users_exposed',
    category: 'security',
  },
  {
    ...
    docsLink:
      'https://powerbase.club/docs/guides/database/database-linter?queryGroups=lint&lint=0003_auth_rls_initplan',
    category: 'performance',
  },
  {
    name: 'no_primary_key',
    ...
    linkText: 'View table',
    docsLink:
      'https://powerbase.club/docs/guides/database/database-linter?queryGroups=lint&lint=0004_no_primary_key',
    category: 'performance',
  },
  {
    name: 'unused_index',
    ...
    linkText: 'View index',
    docsLink:
      'https://powerbase.club/docs/guides/database/database-linter?queryGroups=lint&lint=0005_unused_index',
    category: 'performance',
  },
  {
    ...
    linkText: 'View policies',
    docsLink:
      'https://powerbase.club/docs/guides/database/database-linter?queryGroups=lint&lint=0006_multiple_permissive_policies',
    category: 'performance',
  },
  {
    ...
    linkText: 'View policies',
    docsLink:
      'https://powerbase.club/docs/guides/database/database-linter?queryGroups=lint&lint=0007_policy_exists_rls_disabled',
    category: 'security',
  },
  {
    ...
    linkText: 'View table',
    docsLink:
      'https://powerbase.club/docs/guides/database/database-linter?queryGroups=lint&lint=0008_rls_enabled_no_policy',
    category: 'security',
  },
  {
    ...
    linkText: 'View index',
    docsLink:
      'https://powerbase.club/docs/guides/database/database-linter?queryGroups=lint&lint=0009_duplicate_index',
    category: 'performance',
  },
  {
    ...
    link: () =>
      'https://powerbase.club/docs/guides/database/database-linter?queryGroups=lint&lint=0010_security_definer_view',
    linkText: 'View docs',
    docsLink:
      'https://powerbase.club/docs/guides/database/database-linter?queryGroups=lint&lint=0010_security_definer_view',
    category: 'security',
  },
  {
    ...
    docsLink:
      'https://powerbase.club/docs/guides/database/database-linter?queryGroups=lint&lint=0011_function_search_path_mutable',
    category: 'security',
  },
  {
    ...
    linkText: 'View policies',
    docsLink:
      'https://powerbase.club/docs/guides/database/database-linter?queryGroups=lint&lint=0013_rls_disabled_in_public',
    category: 'security',
  },
  {
    ...
    docsLink:
      'https://powerbase.club/docs/guides/database/database-linter?queryGroups=lint&lint=0014_extension_in_public',
    category: 'security',
  },
  {
    ...
    docsLink: 'https://powerbase.club/docs/guides/platform/going-into-prod#security',
    category: 'security',
  },
  {
  ...
  },
  {
    ...
    linkText: 'View policies',
    docsLink:
      'https://powerbase.club/docs/guides/database/database-linter?queryGroups=lint&lint=0015_rls_references_user_metadata',
    category: 'security',
  },
  {
    ...
    icon: <Eye className="text-foreground-muted" size={15} strokeWidth={1.5} />,
    link: () =>
      `https://powerbase.club/docs/guides/database/database-advisors?lint=0016_materialized_view_in_api`,
    linkText: 'View docs',
    docsLink:
      'https://powerbase.club/docs/guides/database/database-advisors?lint=0016_materialized_view_in_api',
    category: 'security',
  },
  {
    ...
    link: () =>
      `https://powerbase.club/docs/guides/database/database-linter?lint=0017_foreign_table_in_api`,
    linkText: 'View docs',
    docsLink:
      'https://powerbase.club/docs/guides/database/database-linter?lint=0017_foreign_table_in_api',
    category: 'security',
  },
  {
    ...
    icon: <Table2 className="text-foreground-muted" size={15} strokeWidth={1.5} />,
    link: () =>
      `https://powerbase.club/docs/guides/database/database-advisors?lint=0018_unsupported_reg_types&queryGroups=lint`,
    linkText: 'View docs',
    docsLink:
      'https://powerbase.club/docs/guides/database/database-advisors?lint=0018_unsupported_reg_types&queryGroups=lint',
    category: 'security',
  },
  {
    ...
    linkText: 'View settings',
    docsLink: 'https://powerbase.club/docs/guides/platform/ssl-enforcement',
    category: 'security',
  },
  {
    ...
    link: ({ projectRef }) => `/project/${projectRef}/settings/database`,
    linkText: 'View settings',
    docsLink: 'https://powerbase.club/docs/guides/platform/network-restrictions',
    category: 'security',
  },
  {
  ...
  },
  {
    ...
    linkText: 'View settings',
    docsLink: 'https://powerbase.club/docs/guides/platform/backups#point-in-time-recovery',
    category: 'security',
  },
  {
    ...
    linkText: 'View settings',
    docsLink:
      'https://powerbase.club/docs/guides/auth/password-security#password-strength-and-leaked-password-protection',
    category: 'security',
  },
  {
    ...
    link: ({ projectRef }) => `/project/${projectRef}/settings/auth`,
    linkText: 'View settings',
    docsLink: 'https://powerbase.club/docs/guides/auth/auth-mfa',
    category: 'security',
  },
  {
    ...
    link: ({ projectRef }) => `/project/${projectRef}/settings/auth`,
    linkText: 'View settings',
    docsLink: 'https://powerbase.club/docs/guides/auth/password-security',
    category: 'security',
  },
  {
    ...
    linkText: 'View settings',
    docsLink: 'https://powerbase.club/docs/guides/api/api-keys#the-servicerole-key',
    category: 'security',
  },
  {
