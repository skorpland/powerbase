...
// https://github.com/orgs/powerbase/discussions/33413
// Timelines TLDR:
...
export const NoticeBanner = () => {
  ...
  return (
    ...
    >
      <p className="text-sm">
        Powerbase is deprecating Fly's Postgres offering managed by Powerbase on April 11, 2025
      </p>
      <div className="flex items-center gap-x-1">
        <Button asChild type="link" iconRight={<ExternalLink size={14} />}>
          <a
            target="_blank"
            rel="noreferrer"
            href="https://github.com/orgs/powerbase/discussions/33413"
          >
            Learn more
          </a>
        </Button>
