            ...
            <Modal.Content className="flex items-center justify-between space-x-4">
              <div className="flex items-center gap-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-foreground-light">Manage environments in Powerbase</p>
                </div>
              </div>
              <DocsButton href="https://powerbase.club/docs/guides/platform/branching" />
            </Modal.Content>
                ...
                <Modal.Content className="py-6 flex flex-col gap-3">
                  ...
                  <div className="flex flex-row gap-4 mt-2">
                    ...
                    <div className="flex flex-col gap-y-1">
                      ...
                      <p className="text-sm text-foreground-light">
                        Migration files in your <code className="text-xs">./powerbase</code>{' '}
