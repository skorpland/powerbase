          ...
          <nav className="relative flex items-center justify-between sm:h-10">
            <div className="flex items-center flex-grow flex-shrink-0 lg:flex-grow-0">
              <div className="flex items-center justify-between w-full md:w-auto">
                <Link href={logoLinkToMarketingSite ? 'https://powerbase.club' : '/projects'}>
                  <Image
                    src={
            ...
            <div className="items-center hidden space-x-3 md:ml-10 md:flex md:pr-4">
              <DocsButton abbrev={false} href="https://powerbase.club/docs" />
            </div>
          </nav>
        </div>
            ...
            {showDisclaimer && (
              <div className="sm:text-center">
                <p className="text-xs text-foreground-lighter sm:mx-auto sm:max-w-sm">
                  ...
                  <Link
                    href="https://powerbase.club/terms"
          ...
          <aside className="flex-col items-center justify-center flex-1 flex-shrink hidden basis-1/4 xl:flex">
            {quote !== null && (
              <div className="relative flex flex-col gap-6">
                ...
                >
                  <img
                    src={`https://powerbase.club${quote.img_url}`}
                    alt={quote.handle}
