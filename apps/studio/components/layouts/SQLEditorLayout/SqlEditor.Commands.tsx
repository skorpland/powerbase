import { type PostgresColumn } from '@skorpland/postgres-meta'
...
function TableSelector() {
  ...
  const {
    ...
    { select: excludePowerbaseControlledSchemas }
  )
...
function excludePowerbaseControlledSchemas(tables: TablesData) {
