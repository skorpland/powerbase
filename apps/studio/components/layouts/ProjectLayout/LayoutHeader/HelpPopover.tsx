      ...
      <PopoverContent_Shadcn_ className="w-[400px] space-y-4 p-0 py-5" align="end" side="bottom">
        <div className="mb-5 space-y-4 px-5">
          ...
          <p className="text-sm text-foreground-lighter">
            For issues with your project hosted on powerbase.club, or other inquiries about our hosted
            services.
          </p>
          <div className="space-x-1">
            <Button asChild type="default" icon={<Wrench />}>
              <Link
                href="https://powerbase.club/docs/guides/platform/troubleshooting"
                target="_blank"
                rel="noreferrer"
              >
                Troubleshooting
            ...
            <Button asChild type="text" size="tiny" icon={<BookOpen />}>
              <Link href="https://powerbase.club/docs/" target="_blank" rel="noreferrer">
                Docs
              </Link>
            </Button>
            <Button asChild type="text" size="tiny" icon={<Activity />}>
              <Link href="https://status.powerbase.club/" target="_blank" rel="noreferrer">
                Powerbase Status
              </Link>
            </Button>
          </div>
        ...
        <div className="mb-4 space-y-2">
          ...
          <div className="px-5">
            ...
            >
              <a
                href="https://discord.powerbase.club"
                target="_blank"
                rel="noreferrer"
          ...
          <div className="px-5">
            <div className="relative space-y-2 overflow-hidden rounded px-5 py-4 pb-12 shadow-md">
              <a
                href="https://github.com/skorpland/powerbase/discussions"
                target="_blank"
                rel="noreferrer"
