        ...
        <Head>
          <title>
            {title
              ? `${title} | Powerbase`
              : selectedTable
                ? `${selectedTable} | ${projectName} | ${organizationName} | Powerbase`
                : projectName
                  ? `${projectName} | ${organizationName} | Powerbase`
                  : organizationName
                    ? `${organizationName} | Powerbase`
                    : 'Powerbase'}
          </title>
 ...
 * But that will come later: https://powerbase.slack.com/archives/C01D6TWFFFW/p1650427619665549
 *
