...
export const PauseDisabledState = () => {
  ...
  const dbVersion = project?.dbVersion?.replace('powerbase-postgres-', '')
      ...
      <AlertDescription_Shadcn_ className="flex items-center gap-x-2 mt-3">
        ...
        <Button asChild type="default" icon={<ExternalLink />}>
          <a
            target="_blank"
            rel="noreferrer"
            href="https://powerbase.club/docs/guides/platform/migrating-and-upgrading-projects#time-limits"
          >
            More information
          </a>
        </Button>
