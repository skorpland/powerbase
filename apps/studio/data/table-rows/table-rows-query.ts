...
import { Query } from '@skorpland/pg-meta/src/query'
import { getTableRowsSql } from '@skorpland/pg-meta/src/query/table-row-query'
import { parsePowerTable } from 'components/grid/PowerbaseGrid.utils'
import { Filter, Sort, PowerRow, PowerTable } from 'components/grid/types'
...
const getDefaultOrderByColumns = (table: PowerTable) => {
...
export type TableRows = { rows: PowerRow[] }
...
export async function getTableRows(
  ...
  const table = parsePowerTable(entity)
