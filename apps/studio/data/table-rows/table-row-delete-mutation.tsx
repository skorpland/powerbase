...
import type { PowerRow } from 'components/grid/types'
            ...
            toast(initialMessage, {
              ...
              action: (
                <div className="w-full flex gap-x-2 !mx-0 mt-3">
                  ...
                  <DocsButton href="https://powerbase.club/docs/guides/database/postgres/cascade-deletes" />
                </div>
              ),
            })
          } else if (isPkError) {
            toast('Unable to delete row(s) as table has no primary keys', {
              description: (
                <div>
                  ...
                  <div className="mt-3">
                    <DocsButton href="https://powerbase.club/docs/guides/database/tables#primary-keys" />
                  </div>
                </div>
              ),
            })
