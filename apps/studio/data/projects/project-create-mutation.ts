...
const WHITELIST_ERRORS = [
  ...
  'Project creation in the Powerbase dashboard is disabled for this Vercel-managed organization.',
  'Your account, which is handled by the Fly Powerbase extension, cannot access this endpoint.',
...
export async function createProject({
  ...
  const body: components['schemas']['CreateProjectBody'] = {
    ...
    ...(customPowerbaseRequest !== undefined && {
      custom_powerbase_internal_requests: customPowerbaseRequest as any,
    }),
