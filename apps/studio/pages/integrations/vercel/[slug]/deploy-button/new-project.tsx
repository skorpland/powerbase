        ...
        <ScaffoldColumn className="mx-auto w-full max-w-md">
          <header>
            ...
            <Markdown
              ...
              content={`Choose the Powerbase organization you wish to install in`}
            />
          </header>
          <CreateProject />
          <Alert withIcon variant="info" title="You can uninstall this Integration at any time.">
            <Markdown
              content={`You can remove this integration at any time via Vercel or the Powerbase dashboard.`}
            />
          </Alert>
        </ScaffoldColumn>
      </ScaffoldContainer>
...
const CreateProject = () => {
        ...
        try {
          const { id: connectionId } = await createConnections({
            ...
            connection: {
              ...
              powerbase_project_ref: newProjectRef,
              integration_id: '0',
              metadata: {
                ...projectDetails,
                powerbaseConfig: {
  ...
  return (
    <div>
      <p className="mb-2">Powerbase project details</p>
      <div className="py-2">
        <Input
          autoFocus
          id="projectName"
