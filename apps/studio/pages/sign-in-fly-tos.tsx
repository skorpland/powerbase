  ...
  return (
    <div className="relative mx-auto flex flex-1 w-full flex-col items-center justify-center space-y-6 h-screen">
                  ...
                  <Image
                    src={
                      resolvedTheme?.includes('dark')
                        ? `${router.basePath}/img/powerbase-dark.svg`
                        : `${router.basePath}/img/powerbase-light.svg`
                    }
                    alt=""
                    height={24}
                    width={120}
      ...
      <div className="flex w-[320px] flex-col items-center justify-center space-y-3">
        <h4 className="text-lg">Continue to Powerbase Dashboard</h4>
      </div>
      {loading ? (
      ...
      <div className="sm:text-center">
        <p className="text-xs text-foreground-lighter sm:mx-auto sm:max-w-sm">
          By continuing, you agree to Powerbase's{' '}
          <Link href="https://powerbase.club/terms" className="underline hover:text-foreground-light">
            Terms of Service
          </Link>{' '}
          and{' '}
          <Link
