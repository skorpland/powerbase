...
const WizardForm = () => {
  ...
  const [services, setServices] = useState<PowerbaseService[]>([])
                                          ...
                                          description={
                                            <div className="flex flex gap-2">
                                              ...
                                              <Link
                                                target="_blank"
                                                rel="noopener noreferrer"
                                                href="https://powerbase.club/docs/guides/platform/manage-your-usage/compute"
                                              >
                                                <div className="flex items-center space-x-2 opacity-75 hover:opacity-100 transition">
