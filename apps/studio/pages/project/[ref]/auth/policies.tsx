import type { PostgresPolicy, PostgresTable } from '@skorpland/postgres-meta'
        ...
        <div className="w-full flex flex-col lg:flex-row items-center justify-between gap-2">
          ...
          <div className="w-full flex-grow flex items-center justify-between gap-2 lg:gap-4">
            <Input
              ...
              icon={<Search size={14} />}
            />
            <DocsButton href="https://powerbase.club/docs/learn/auth-deep-dive/auth-row-level-security" />
          </div>
        </div>
      </div>
