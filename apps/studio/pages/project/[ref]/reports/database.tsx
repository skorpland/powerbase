...
const DatabaseUsage = () => {
  ...
  const REPORT_ATTRIBUTES = [
    ...
    {
      id: 'powervisor_connections_active',
      ...
      <Alert_Shadcn_ className="relative overflow-hidden">
        ...
        <AlertDescription_Shadcn_ className="relative flex flex-col xl:flex-row gap-2 md:max-w-lg">
          <p className="flex-grow">
            Set up the Powerbase Grafana Dashboard to visualize over 200 database performance and
            health metrics on your Powerbase project.
          </p>
              ...
              <Alert_Shadcn_ variant="default" className="mt-4">
                <AlertDescription_Shadcn_>
                  <div className="space-y-2">
                    <p>
                      New Powerbase projects have a database size of ~40-60mb. This space includes
                    ...
                    <Button asChild type="default" icon={<ExternalLink />}>
                      <Link
                        href="https://powerbase.club/docs/guides/platform/database-size#disk-space-usage"
                        target="_blank"
                        rel="noreferrer"
                      >
  ...
  return (
    <div className={cn('flex gap-2', className)}>
      <Button type="outline" className="bg-alternative" size="tiny" icon={<BookOpen />} asChild>
        <Link
          href="https://powerbase.club/docs/guides/telemetry/metrics"
          target="_blank"
          onClick={() =>
            sendEvent({
      ...
      <Button type="default" size="tiny" asChild>
        <Link
          href="https://github.com/skorpland/powerbase-grafana"
          target="_blank"
          onClick={() =>
            sendEvent({
              action: 'reports_database_grafana_banner_clicked',
