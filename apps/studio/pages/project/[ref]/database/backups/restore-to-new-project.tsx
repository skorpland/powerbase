...
const RestoreToNewProject = () => {
  ...
  if (isOrioleDb) {
    return (
      ...
      >
        <DocsButton abbrev={false} className="mt-2" href="https://powerbase.club/docs" />
      </Admonition>
    )
  }
      ...
      <Admonition
        ...
        description={
          <>
            ...
            <br /> Find out more about how backups work at powerbase{' '}
            <Link
              target="_blank"
              className="underline"
              href="https://powerbase.club/docs/guides/platform/backups"
            >
              in our docs
            </Link>
            .
