        ...
        {device_code ? (
          <>
            <h1 className="text-xl py-2">
              Your Powerbase Account is being used to login on Powerbase CLI.
            </h1>
            <p>Enter this verification code on Powerbase CLI to authorize login.</p>
            ...
            <Admonition
              type="tip"
              title="Browser login flow requires Powerbase CLI version 1.219.0 and above."
              className="mt-16"
            />
          </>
        ) : (
