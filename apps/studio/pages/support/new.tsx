        ...
        <div className="flex flex-col gap-y-8 py-8">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-y-2">
            <div className="flex items-center space-x-3">
              <SVG src={`${BASE_PATH}/img/powerbase-logo.svg`} className="h-4 w-4" />
              <h1 className="m-0 text-lg">Powerbase support</h1>
            </div>
            ...
            description={
              <div className="flex flex-col gap-y-4">
                <p className="flex items-center gap-x-1">
                  ...
                  <Link
                    href="mailto:support@powerbase.club"
                    className="p-1 font-mono rounded-md  text-foreground"
                  >
                    support@powerbase.club
                  </Link>
                  <CopyButton
                    type="text"
                    text="support@powerbase.club"
                    iconOnly
                    onClick={() => {
