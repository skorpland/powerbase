...
//   ...['powervisor', 'postgrest', 'storage', 'realtime', 'powervisor'].map((queryType) => ({
//     queryType,
//     tableName: undefined,
//     tableLog: logDataFixture({
//       event_message: 'some message',
...
//   // bugfix for https://sentry.io/organizations/powerbase/issues/2903331460/?project=5459134&referrer=slack
//   get.mockImplementation((url) => {
//     if (url.includes('count')) {
//       return {}
//     }
