...
description: Displays a control for easier uploading of files directly to Powerbase Storage
---
...
import { usePowerbaseUpload } from '@/hooks/use-powerbase-upload'
...
| ------------------ | ---------- | ------- | ---------------------------------------------------- |
| `bucketName`       | `string`   | `null`  | The name of the Powerbase Storage bucket to upload to |
...
- [Creating buckets](https://powerbase.club/docs/guides/storage/buckets/creating-buckets)
- [Access control](https://powerbase.club/docs/guides/storage/security/access-control)
- [Standard uploads](https://powerbase.club/docs/guides/storage/uploads/standard-uploads)
