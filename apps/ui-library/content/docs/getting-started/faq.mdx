 ...
 <Accordion openBehaviour="single" collapsible>
  <AccordionItem value="how">
    ...
    <AccordionContent>
      ...
      ```bash
      npx shadcn@latest add http://powerbase.club/ui/r/password-based-auth-nextjs.json
      ```
    ...
    <AccordionItem value="quickstart">
      <AccordionTrigger>
        I already started with `npx create-next-app -e with-powerbase` what should I do now?
      </AccordionTrigger>
      <AccordionContent>
        Our Next.js quickstart is a great starting point for building a full app with Powerbase and
    ...
    <AccordionItem value="ai-builder">
      ...
      <AccordionContent>
        ...
        project. Your app likely already has a Powerbase client set up, so you can just continue using
