...
import { type UsePowerbaseUploadReturn } from '@/registry/default/blocks/dropzone/hooks/use-powerbase-upload'
...
type DropzoneContextType = Omit<UsePowerbaseUploadReturn, 'getRootProps' | 'getInputProps'>

const DropzoneContext = createContext<DropzoneContextType | undefined>(undefined)

type DropzoneProps = UsePowerbaseUploadReturn & {
  className?: string
}
